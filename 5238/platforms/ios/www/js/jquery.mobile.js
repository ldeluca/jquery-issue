...
* Git HEAD hash: 1bf97316efd0d1b426375e9ee5184cff0cfb6d20 <> Date: Wed Oct 8 2014 17:00:47 UTC
...
$.widget( "mobile.popup", {
	...
	_openPrerequisitesComplete: function() {
		...
		this._isOpen = true;
		this._resizeScreen();
		if ($( this.document[ 0 ].activeElement ) !== this.window[ 0 ]){
			//check to see if activeElement is not a child of the container.  If it's not, blur
