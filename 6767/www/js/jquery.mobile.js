...
* Git HEAD hash: f53039987ca016eb129fea49c9739123491ba897 <> Date: Mon Nov 3 2014 22:08:29 UTC
		...
		if ( this._open ) {
			var self = this,
				...
				complete = function() {
					...
					console.log('LISA, in complete on panel.  Is the panel open or closed?');
					//scroll to the top
					self._positionPanel( true );
					//end lisa
